...
1. **Ground aircraft list**: Generated by `identify-and-extract.js` (Phase 2)
   - Stored at: `s3://ayryx-adsb-history/ground-aircraft/AIRPORT/YYYY/MM/DD.json`
2. **Extracted traces**: Generated by `identify-and-extract.js` (Phase 2)
   - Stored at: `s3://ayryx-adsb-history/extracted/AIRPORT/YYYY/MM/AIRPORT-YYYY-MM-DD.tar`
...
**No ground aircraft found**: Run `identify-and-extract.js` first to generate the ground aircraft list and extract traces.
